  ...
  return (
    ...
    <div>
        ...
        <ul className="flex text-center pr-8 h-12 text-xs">
            ...
            <Link to="/profile/following" ><li className="pr-2 pl-2 h-full items-center flex font-bold border-b-2 color-tab">Following</li></Link>
        ...
        <div className='flex justify-between pt-2 pb-2'>
          <div className='font-medium'>0 Following</div>
          <div className='text-sm rounded-2xl pt-1 pb-1 pl-2 pr-2 hover:bg-gray-100 hover:cursor-pointer'>Spaces<FontAwesomeIcon icon={faAngleDown} className='pl-1'/></div>
        </div>
        <div className='border-t p-4'>
          ...
          <div className='mx-auto w-fit pt-2'>You aren't following any Spaces yet.</div>
          </div>
        </div>
    </div>
    )
