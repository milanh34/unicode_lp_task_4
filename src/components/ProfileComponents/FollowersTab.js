  ...
  return (
    ...
    <div>
        ...
        <ul className="flex text-center pr-8 h-12 text-xs">
            ...
            <Link to="/profile/followers" ><li className="pr-2 pl-2 h-full items-center flex font-bold border-b-2 color-tab">{user.followers.length} Followers</li></Link>
        ...
        <div className='flex justify-between pt-2 pb-2'>
          <div className='font-medium'>0 Followers</div>
        </div>
        <div className='border-t p-4'>
          ...
          <div className='mx-auto w-fit pt-2'>You don't have followers yet.</div>
          </div>
        </div>
    </div>
    )
