  ...
  return (
    ...
    <div>
        ...
        <ul className="flex text-center pr-8 h-12 text-xs">
            <Link to="/profile" ><li className="pr-2 pl-2 h-full items-center flex font-bold border-b-2 color-tab">Profile</li></Link>
            ...
            <Link to="/profile/activity" ><li className="pr-2 pl-2 h-full items-center flex hover:bg-gray-100 font-bold text-gray-500">Activity</li></Link>
        </ul>
        </div>
        <div className='flex justify-between pt-2 pb-2'>
          <div className='font-medium'>Profile</div>
          <div className='text-sm rounded-2xl pt-1 pb-1 pl-2 pr-2 hover:bg-gray-100 hover:cursor-pointer'>Most Recent<FontAwesomeIcon icon={faAngleDown} className='pl-1'/></div>
        </div>
        <div className='border-t p-4'>
          ...
          <div className='mx-auto w-fit pt-2'>You haven't shared, answered or posted anything yet.</div>
          </div>
          <div className='mx-auto w-fit'><Link to='/answer' className='rounded-3xl border-0 p-2 pr-4 pl-4 bg-indigo-500 text-white'>Answer questions</Link></div>
        </div>
    </div>
    )
  }
