  ...
  return (
    ...
    <div>
        ...
        <ul className="flex text-center pr-8 h-12 text-xs">
            ...
            <Link to="/profile/log" ><li className="pr-2 pl-2 h-full items-center flex font-bold border-b-2 color-tab">Edits</li></Link>
        ...
        <div className='border-t p-4'>
          ...
          <div className='mx-auto w-fit pt-2'>You haven't edited any content yet.</div>
          </div>
        </div>
    </div>
    )
