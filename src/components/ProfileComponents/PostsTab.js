  ...
  return (
    ...
    <div>
        ...
        <ul className="flex text-center pr-8 h-12 text-xs">
            ...
            <Link to="/profile/posts" ><li className="pr-2 pl-2 h-full items-center flex font-bold border-b-2 color-tab">{user.comments.length} Posts</li></Link>
        ...
        <div className='flex justify-between pt-2 pb-2'>
          <div className='font-medium'>0 Posts</div>
        </div>
        <div className='border-t p-4'>
          ...
          <div className='mx-auto w-fit pt-2'>You haven't posted any content yet.</div>
          </div>
        </div>
    </div>
    )
