...
export default function AnswersTab2() {
    ...
    <div>
        <div className='mt-8'>
                    <ul className='flex'>
                        ...
                        <Link to='/myprofile/answers'><li className='pt-2 pb-2 mr-2 mb-2 rounded-3xl border-0 colour text-white w-32 text-center font-medium text-lg'>Answered</li></Link>
